...
bg=pygame.image.load("Images/CHAIN.png").convert()
patch=pygame.image.load("Images/GreyBack.png").convert()
greenball=pygame.image.load("Images/OGB1.png")
redball=pygame.image.load("Images/ORB1.png")
doublegreenball=pygame.image.load("Images/DGB1.png")
doubleredball=pygame.image.load("Images/DRB1.png")
triplegreenball=pygame.image.load("Images/TGB1.png")
tripleredball=pygame.image.load("Images/TRB1.png")
Quadgreenball=pygame.image.load("Images/QGB1.png")
Quadredball=pygame.image.load("Images/QRB1.png")
Pentagreenball=pygame.image.load("Images/PGB1.png")
Pentaredball=pygame.image.load("Images/PRB1.png")
Hexagreenball=pygame.image.load("Images/HGB!.png")
Hexaredball=pygame.image.load("Images/HRB1.png")
Heptagreenball=pygame.image.load("Images/GB7.png")
Heptaredball=pygame.image.load("Images/RB7.png")
Rules=pygame.image.load("Images/Rules.png")
RR=pygame.image.load("Images/RulesNReg.png")
background=pygame.image.load("Images/Background.png").convert()
backgroundlite=pygame.image.load("Images/Backgroundlite.png").convert()
Startscreen=pygame.image.load("Images/StartGame.png").convert()
Startbutton=pygame.image.load("Images/StartButton2.png").convert()
WinnerRed=pygame.image.load("Images/red_won.png")
WinnerGreen=pygame.image.load("Images/green_won1.png")
#Sound
pygame.mixer.init()
Click_Sound=pygame.mixer.Sound("Sounds/Select.wav")
Click_Sound1=pygame.mixer.Sound("Sounds/Select2.wav")
...
def GameEndRed():
	...
	pygame.mixer.music.load("Sounds/Thug.mp3")
...
def GameEndGreen():
	...
	pygame.time.delay(2000)
	screenEnd=pygame.display.set_mode((395,395))
	WinnerGreen=pygame.image.load("Images/green_won.png")
	WG.rect.x=0
	WG.rect.y=0
